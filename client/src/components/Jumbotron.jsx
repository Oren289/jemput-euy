      ...
      <div className='container px-md-5 py-5'>
        <div className='row'>
          <div className='col-md-6 '>
            ...
            <p className='text-light'>Buang sampah besar dari rumah. Daftar sekarang untuk dapatkan layanannya dan petugas kami yang akan menjemput ke rumah wargi Bandung.</p>
          </div>
